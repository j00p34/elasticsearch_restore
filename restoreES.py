...
#request = urllib2.Request('http://localhost:9200/contentrepo-2014-09-23/_close', data=None)
request1 = urllib2.Request('http://localhost:9200/contentrepo-2014-09-93/_close', data=None)
